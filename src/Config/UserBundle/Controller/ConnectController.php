...
class ConnectController extends Controller
{
    ...
    public function connectAction(Request $request)
    {
        ...
        return $this->render('ConfigUserBundle:Connect:login.html.'.$this->getTemplatingEngine(), array(
            'error'   => $error,
        ));
    }
    ...
    public function registrationAction(Request $request, $key)
    {
        ...
        if ($formHandler->process($request, $form, $userInformation)) {
            ...
            return $this->render('ConfigUserBundle:Connect:registration_success.html.'.$this->getTemplatingEngine(), array(
        ...
        return $this->render('ConfigUserBundle:Connect:registration.html.'.$this->getTemplatingEngine(), array(
            'key' => $key,
    ...
    public function connectServiceAction(Request $request, $service)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->render('ConfigUserBundle:Connect:connect_success.html.' . $this->getTemplatingEngine(), array(
                'userInformation' => $userInformation,
                'service' => $service,
            ));
        }

        return $this->render('ConfigUserBundle:Connect:connect_confirm.html.' . $this->getTemplatingEngine(), array(
            'key' => $key,
            'service' => $service,
            'form' => $form->createView(),
            'userInformation' => $userInformation,
